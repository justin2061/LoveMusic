...
public class MainActivity extends Activity implements OnClickListener {
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getGroupId() == 1) {// 远程音乐
			...
			case MENU_LISTEN_MUSIC:
				...
				progressDialog.setMessage("音乐正在缓冲中,请稍候");
				progressDialog.show();
  ...
  public void setMyAlarm()  
	...
	private void ShareMusicFile() {
		...
		intent.putExtra(Intent.EXTRA_TEXT,"当前被分享歌曲："+music.getMusicName()+"(用户通过此应用分享了一首歌曲)");
